...
/**
 * This is the item provider adapter for a {@link it.disim.univaq.porcessmanagement.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends DescriptedItemProvider {
	/**
	...
	protected void addCoordinatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_coordinates_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_coordinates_feature",
								"_UI_Location_type"),
						PorcessmanagementPackage.Literals.LOCATION__COORDINATES, true, false, false,
