...
public class ProblemImpl extends DescriptedImpl implements Problem {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate IS_AUTHOR_ADMIN__EINVOCATION_DELEGATE = ((EOperation.Internal)CooltivarPackage.Literals.PROBLEM___IS_AUTHOR_ADMIN).getInvocationDelegate();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CooltivarPackage.PROBLEM___IS_AUTHOR_ADMIN:
