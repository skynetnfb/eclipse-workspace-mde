 ...
 * </p>
 * <ul>
 *   <li>{@link cooltivar.impl.ApplicationImpl#getUser <em>User</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationImpl extends MinimalEObjectImpl.Container implements Application {
	...
	protected EClass eStaticClass() {
		return CooltivarPackage.Literals.APPLICATION;
	}
	...
	public EList<User> getUser() {
		if (user == null) {
			user = new EObjectContainmentEList<User>(User.class, this, CooltivarPackage.APPLICATION__USER);
		}
		return user;
	}
