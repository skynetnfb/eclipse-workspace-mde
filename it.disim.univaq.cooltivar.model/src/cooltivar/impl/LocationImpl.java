 ...
 * </p>
 * <ul>
 *   <li>{@link cooltivar.impl.LocationImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationImpl extends DescriptedImpl implements Location {
	...
	protected EClass eStaticClass() {
		return CooltivarPackage.Literals.LOCATION;
	}
	...
	public void setCoordinates(String newCoordinates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CooltivarPackage.LOCATION__COORDINATES, oldCoordinates, coordinates));
	}
