 ...
 *   <li>{@link it.disim.univaq.cooltivar.cooltivar.Action#getProblem <em>Problem</em>}</li>
 *   <li>{@link it.disim.univaq.cooltivar.cooltivar.Action#getSolution <em>Solution</em>}</li>
 *   <li>{@link it.disim.univaq.cooltivar.cooltivar.Action#getActionsType <em>Actions Type</em>}</li>
 *   <li>{@link it.disim.univaq.cooltivar.cooltivar.Action#getActionStatus <em>Action Status</em>}</li>
 *   <li>{@link it.disim.univaq.cooltivar.cooltivar.Action#getFullDescription <em>Full Description</em>}</li>
 *   <li>{@link it.disim.univaq.cooltivar.cooltivar.Action#getProcess <em>Process</em>}</li>
 * </ul>
 *
...
public interface Action extends Descripted {
	 ...
	 * @see it.disim.univaq.cooltivar.cooltivar.ModelPackage#getAction_Problem()
	 * @model
	 * @generated
	 */
	Problem getProblem();
	...
	/**
	 * Sets the value of the '{@link it.disim.univaq.cooltivar.cooltivar.Action#getProblem <em>Problem</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.disim.univaq.cooltivar.cooltivar.ModelPackage#getAction_Solution()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link it.disim.univaq.cooltivar.cooltivar.Action#getSolution <em>Solution</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link it.disim.univaq.cooltivar.cooltivar.ActionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.disim.univaq.cooltivar.cooltivar.ModelPackage#getAction_ActionsType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link it.disim.univaq.cooltivar.cooltivar.Action#getActionsType <em>Actions Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link it.disim.univaq.cooltivar.cooltivar.ActionStatus}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.disim.univaq.cooltivar.cooltivar.ModelPackage#getAction_ActionStatus()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link it.disim.univaq.cooltivar.cooltivar.Action#getActionStatus <em>Action Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.disim.univaq.cooltivar.cooltivar.ModelPackage#getAction_FullDescription()
	 * @model derived="true"
	...
	/**
	 * Sets the value of the '{@link it.disim.univaq.cooltivar.cooltivar.Action#getFullDescription <em>Full Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setProcess(it.disim.univaq.cooltivar.cooltivar.Process)
	 * @see it.disim.univaq.cooltivar.cooltivar.ModelPackage#getAction_Process()
	 * @model required="true"
	 * @generated
	 */
	it.disim.univaq.cooltivar.cooltivar.Process getProcess();

	/**
	 * Sets the value of the '{@link it.disim.univaq.cooltivar.cooltivar.Action#getProcess <em>Process</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setProcess(it.disim.univaq.cooltivar.cooltivar.Process value);
