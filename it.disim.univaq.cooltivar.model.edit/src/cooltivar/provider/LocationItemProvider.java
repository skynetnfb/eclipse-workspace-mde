...
/**
 * This is the item provider adapter for a {@link cooltivar.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends DescriptedItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_coordinates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_coordinates_feature", "_UI_Location_type"),
				 CooltivarPackage.Literals.LOCATION__COORDINATES,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Location.class)) {
			case CooltivarPackage.LOCATION__COORDINATES:
