...
/**
 * This is the item provider adapter for a {@link cooltivar.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CooltivarPackage.Literals.APPLICATION__USER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Application.class)) {
			case CooltivarPackage.APPLICATION__USER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CooltivarPackage.Literals.APPLICATION__USER,
				 CooltivarFactory.eINSTANCE.createUser()));
	}
