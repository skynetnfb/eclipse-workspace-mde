 ...
 * @generated
 */
public class AgriSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AgriPackage.AGRI: {
			Agri agri = (Agri) theEObject;
			T result = caseAgri(agri);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Agri</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Agri</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAgri(Agri object) {
		return null;
	}
