...
public class CoolSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == CooltivarPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case CooltivarPackage.ACTION:
				sequence_Action(context, (cooltivar.Action) semanticObject); 
				return; 
			...
			case CooltivarPackage.PROCESS:
				sequence_Process(context, (cooltivar.Process) semanticObject); 
				return; 
	 ...
	 *     )
	 */
	protected void sequence_Action(ISerializationContext context, cooltivar.Action semanticObject) {
	 ...
	 *     )
	 */
	protected void sequence_Process(ISerializationContext context, cooltivar.Process semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
