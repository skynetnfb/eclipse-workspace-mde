...
/**
 * This is the item provider adapter for a {@link it.disim.univaq.porcessmanagement.Solution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionItemProvider extends DescriptedItemProvider {
	/**
	...
	protected void addAuthorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Solution_author_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Solution_author_feature",
								"_UI_Solution_type"),
						PorcessmanagementPackage.Literals.SOLUTION__AUTHOR, true, false, true, null, null, null));
	}
	...
	protected void addProblemsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Solution_problems_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Solution_problems_feature",
								"_UI_Solution_type"),
						PorcessmanagementPackage.Literals.SOLUTION__PROBLEMS, true, false, true, null, null, null));
	}
