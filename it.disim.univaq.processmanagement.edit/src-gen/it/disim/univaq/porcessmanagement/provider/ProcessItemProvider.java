...
/**
 * This is the item provider adapter for a {@link it.disim.univaq.porcessmanagement.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends DescriptedItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_itemProcess_feature",
								"_UI_Process_type"),
						PorcessmanagementPackage.Literals.PROCESS__ITEM_PROCESS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_status_feature",
								"_UI_Process_type"),
						PorcessmanagementPackage.Literals.PROCESS__STATUS, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_startDate_feature",
								"_UI_Process_type"),
						PorcessmanagementPackage.Literals.PROCESS__START_DATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_endDate_feature",
								"_UI_Process_type"),
						PorcessmanagementPackage.Literals.PROCESS__END_DATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Process_weight_feature",
								"_UI_Process_type"),
						PorcessmanagementPackage.Literals.PROCESS__WEIGHT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PorcessmanagementPackage.Literals.PROCESS__LOCATION);
			childrenFeatures.add(PorcessmanagementPackage.Literals.PROCESS__ACTION_HISTORY);
		}
	...
	public String getText(Object object) {
		String label = ((it.disim.univaq.porcessmanagement.Process) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(it.disim.univaq.porcessmanagement.Process.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PorcessmanagementPackage.Literals.PROCESS__LOCATION,
				PorcessmanagementFactory.eINSTANCE.createLocation()));

		newChildDescriptors.add(createChildParameter(PorcessmanagementPackage.Literals.PROCESS__ACTION_HISTORY,
				PorcessmanagementFactory.eINSTANCE.createAction()));
	}
