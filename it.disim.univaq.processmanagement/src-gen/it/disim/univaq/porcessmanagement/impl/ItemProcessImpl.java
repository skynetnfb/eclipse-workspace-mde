 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.univaq.porcessmanagement.impl.ItemProcessImpl#getItemProcessType <em>Item Process Type</em>}</li>
 *   <li>{@link it.disim.univaq.porcessmanagement.impl.ItemProcessImpl#getProblems <em>Problems</em>}</li>
 *   <li>{@link it.disim.univaq.porcessmanagement.impl.ItemProcessImpl#getAuthor <em>Author</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemProcessImpl extends DescriptedImpl implements ItemProcess {
	...
	protected EClass eStaticClass() {
		return PorcessmanagementPackage.Literals.ITEM_PROCESS;
	}
	...
	public NotificationChain basicSetItemProcessType(ItemSpecies newItemProcessType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PorcessmanagementPackage.ITEM_PROCESS__ITEM_PROCESS_TYPE, oldItemProcessType, newItemProcessType);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setItemProcessType(ItemSpecies newItemProcessType) {
		if (newItemProcessType != itemProcessType) {
			...
			if (itemProcessType != null)
				msgs = ((InternalEObject) itemProcessType).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PorcessmanagementPackage.ITEM_PROCESS__ITEM_PROCESS_TYPE, null, msgs);
			if (newItemProcessType != null)
				msgs = ((InternalEObject) newItemProcessType).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - PorcessmanagementPackage.ITEM_PROCESS__ITEM_PROCESS_TYPE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PorcessmanagementPackage.ITEM_PROCESS__ITEM_PROCESS_TYPE, newItemProcessType, newItemProcessType));
	}
	...
	public EList<Problem> getProblems() {
		if (problems == null) {
			problems = new EObjectContainmentEList<Problem>(Problem.class, this,
					PorcessmanagementPackage.ITEM_PROCESS__PROBLEMS);
		}
		return problems;
	}
			...
			if (author != oldAuthor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PorcessmanagementPackage.ITEM_PROCESS__AUTHOR, oldAuthor, author));
			}
		}
		return author;
	}
	...
	public void setAuthor(User newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PorcessmanagementPackage.ITEM_PROCESS__AUTHOR,
					oldAuthor, author));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case PorcessmanagementPackage.ITEM_PROCESS__PROBLEMS:
			return getProblems();
		case PorcessmanagementPackage.ITEM_PROCESS__AUTHOR:
			if (resolve)
				return getAuthor();
