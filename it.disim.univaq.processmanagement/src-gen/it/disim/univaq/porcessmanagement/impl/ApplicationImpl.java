 ...
 * </p>
 * <ul>
 *   <li>{@link it.disim.univaq.porcessmanagement.impl.ApplicationImpl#getUser <em>User</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationImpl extends MinimalEObjectImpl.Container implements Application {
	...
	protected EClass eStaticClass() {
		return PorcessmanagementPackage.Literals.APPLICATION;
	}
	...
	public EList<User> getUser() {
		if (user == null) {
			user = new EObjectContainmentEList<User>(User.class, this, PorcessmanagementPackage.APPLICATION__USER);
		}
		return user;
	}
